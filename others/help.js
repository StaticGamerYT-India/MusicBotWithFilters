...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("StaticMusic Help")
      .setAuthor('Click here to invite me!!', 'https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp', 'https://discord.com/api/oauth2/authorize?client_id=803840908125667369&permissions=8&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information! Contact the Owner - Đ₳Ɽ₭ ⧽ StaticGamerYT#8072`, "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp")
      .setColor("#F0EAD6");
