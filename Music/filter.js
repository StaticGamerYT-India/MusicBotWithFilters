...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor("Applying: " + args[0], "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp","https://discord.com/api/oauth2/authorize?client_id=803840908125667369&permissions=8&scope=bot")).then(msg =>{
