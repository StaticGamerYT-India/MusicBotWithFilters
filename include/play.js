...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#F0EAD6")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp")
  ...
  let thumb;
    if (song.thumbnail === undefined) thumb = "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp";
    else thumb = song.thumbnail.url;

  try {
      let embed = new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor(`Started playing: ${song.title}`,'https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp')
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      if (ms > 0 && ms<10000) {
        nowPlaying.addField("\u200b", "**``[" + createBar((ms == 0 ? seek : ms), seek, 25, "▬", "🔘")[0] + "]``**\n**" + "\n[" + new Date(seek * 1000).toISOString().substr(11, 8) + " / " + (ms == 0 ? " ◉ LIVE" : new Date(ms * 1000).toISOString().substr(11, 8))+ "]**" + "\n" + "\n **Time Remaining:**" + "``" + new Date(left * 1000).toISOString().substr(11, 8) + "``", false );
          ...
          .setAuthor("Searching...", "https://cdn.discordapp.com/avatars/584723604181221396/d9793fc78946dc259170dd17869266ea.webp").setFooter("Lyrics")
          .setColor("#F0EAD6")
